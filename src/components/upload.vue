  ...
  <div class="home">
    ...
    <div class="review" v-show="isSubmission">
      ...
      <span class="reviewText">
        <span v-if="status == -1">{{ failureReasons }}</span>
      </span>
    </div>
    <div class="addImg">
      <ul>
      ...
      api.getActivityInfo(data).then(res => {
        if (res.data.code == 200) {
          ...
          if (res.data.data.isHaveWorks === false) {
            ...
            var imgUrl = [
              res.data.data.img1Url,
              res.data.data.img2Url,
              res.data.data.img3Url,
              res.data.data.img4Url,
              res.data.data.img5Url,
              res.data.data.img6Url,
              res.data.data.img7Url,
              res.data.data.img8Url,
              res.data.data.img9Url
            ];
            ...
            self.failureReasons = res.data.data.description;
            self.activeData = '';
          }
        } else {
          self.isloadingshow(false);
          self.isTips(res.data.msg);
          self.activeData = res.data.msg;
        }
      });
    },
    //预览图片
